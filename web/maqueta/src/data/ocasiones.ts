...
export const ocasiones: Ocasion[] = [
  ...
  },
  {
    ...
    copyHero: "Aunque a caballo regalado no se le miran los dientes. Nuestros souvenirs y recordatorios no pasarán desapercibidos y serán un lindo recuerdo de tus momentos especiales."
  },
  {
    slug: "nacimientos",
    nombre: "Nacimientos",
